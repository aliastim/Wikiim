...
if (isset($_SESSION['isConnected']) AND  $_SESSION['isConnected']= true)
{
    if (isset( $_GET['cours']) and !empty( $_GET['cours']))
    {
        ...
        echo $twig->render('cours-3D/cours-A2.html.twig', [
            'title' => 'Cours Animation 3D - A2',
            'cours' => $cours,
            'classe' => $classe,
            'allcours' => $allcours,
    ...
    } else
    {
        ...
        echo $twig->render('cours-3D/cours-3D-A2.html.twig', [
            'title' => 'Cours Animation 3D - A2',
