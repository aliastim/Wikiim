...
if (isset($_SESSION['isConnected']) AND  $_SESSION['isConnected']= true)
{
    if (isset( $_GET['cours']) and !empty( $_GET['cours']))
    {
        $cours = $_GET['cours'];
        //$classe = $_GET['classe'];
        $classe = "Année préparatoire/Restart";
        ...
        echo $twig->render('cours-A1/cours.html.twig', [
            'title' => 'Cours Année Préparatoire',
            'cours' => $cours,
            'classe' => $classe,
            'allcours' => $allcours,
    ...
    } else
    {
        ...
        $cours_categories = $repo->findBy(
            array(
                'axe' => 'Année préparatoire/Restart',
            ),
            array
            (
                'id' => 'DESC',
        ...
        echo $twig->render('cours-A1/cours-A1.html.twig', [
            'title' => 'Cours Année Préparatoire',
