...
if (isset($_SESSION['isConnected']) AND  $_SESSION['isConnected']= true)
{
    if (isset( $_GET['cours']) and !empty( $_GET['cours']))
    {
        ...
        echo $twig->render('cours-JV/cours-A3.html.twig', [
            'title' => 'Cours Jeux vidéo - A3',
            'cours' => $cours,
            'classe' => $classe,
            'allcours' => $allcours,
    ...
    } else
    {
        ...
        echo $twig->render('cours-JV/cours-JV-A3.html.twig', [
            'title' => 'Cours Jeux vidéo - A3',
