...
if (isset($_SESSION['isConnected']) AND  $_SESSION['isConnected']= true)
{
    if (isset( $_GET['cours']) and !empty( $_GET['cours']))
    {
        $cours = $_GET['cours'];
        //$classe = $_GET['classe'];
        $classe = "Bachelor - Développement Web";
        ...
        echo $twig->render('cours-DW/cours-A2.html.twig', [
            'title' => 'Cours Developpement Web - A2',
            'cours' => $cours,
            'classe' => $classe,
            'allcours' => $allcours,
    ...
    } else
    {
        ...
        $cours_categories = $repo->findBy(
            array(
                'axe' => 'Bachelor - Développement Web',
                'annee' => 'A2',
            ),
            array
            (
        ...
        echo $twig->render('cours-DW/cours-DW-A2.html.twig', [
            'title' => 'Cours Developpement Web - A2',
