...
if (isset($_SESSION['isConnected']) AND  $_SESSION['isConnected']= true)
{
    if (isset( $_GET['cours']) and !empty( $_GET['cours']))
    {
        ...
        echo $twig->render('masteres/CSSM-courscategorie.html.twig', [
            'title' => 'Cours Communication et Stratégie Social Média',
            'cours' => $cours,
            'classe' => $classe,
            'allcours' => $allcours,
    ...
    } else
    {
        ...
        echo $twig->render('masteres/CSSM-cours.html.twig', [
            'title' => 'Cours Communication et Stratégie Social Média',
