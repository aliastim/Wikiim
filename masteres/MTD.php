...
if (isset($_SESSION['isConnected']) AND  $_SESSION['isConnected']= true)
{
    if (isset( $_GET['cours']) and !empty( $_GET['cours']))
    {
        ...
        echo $twig->render('masteres/MTD-courscategorie.html.twig', [
            'title' => 'Cours Management de la Transformation Digitale',
            'cours' => $cours,
            'classe' => $classe,
            'allcours' => $allcours,
    ...
    } else
    {
        ...
        echo $twig->render('masteres/MTD-cours.html.twig', [
            'title' => 'Cours Management de la Transformation Digitale',
